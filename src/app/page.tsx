...
export default function Home() {
  return (
    <div className="relative h-full lg:h-[140vh]">
      <main className="relative pb-24 pl-24 lg:space-y-24 lg:pl-16">
        <div className="flex flex-col space-y-2 py-16 md:space-y-4 lg:h-[65vh] lg:justify-end lg:pb-12">
          ...
          <p className="text-shadow-md max-w-xs text-xs md:max-w-lg md:text-lg lg:max-w-2xl">
            ...
            voluptatibus asperiores suscipit quia consectetur voluptatem non
            obcaecati, culpa officia eum dolores, mollitia, iusto eos distinctio
            aperiam corporis beatae eius nostrum.
          </p>
        </div>
